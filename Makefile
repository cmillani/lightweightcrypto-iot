...
ARDUINO_LIBS = arduino_core.a core/wiring_digital.c.o core/HardwareSerial.cpp.o core/HardwareSerial0.cpp.o core/Print.cpp.o core/abi.cpp.o src/arduino/SPI.cpp src/arduino/rfid/MFRC522.cpp
####
