...
INCLUDE_AVR = -I$(ARDUINO_AVR)/cores/arduino -I$(ARDUINO_AVR)/variants/standard
CCAVR = $(ARDUINO_BIN)/avr-g++
ARDUINO_LIBS = arduino_core.a core/wiring_digital.c.o core/HardwareSerial.cpp.o core/HardwareSerial0.cpp.o core/Print.cpp.o core/abi.cpp.o
####
